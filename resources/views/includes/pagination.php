...
class CSSPagination
{
	...
	public function showPage()
	{
		...
		{
			if ($page > 1) 
				$pagination .= "<a href=$this->website$prev".".html>Previous</a>";
			else
			...
			{	
				for ($counter = 1; $counter <= $this->getLastPage(); $counter++)
				{
					if ($counter == $page)
						...
						$pagination .= "<a href=$this->website$counter".".html>".$counter."</a>";					
				}
			}
			...
			if($this->getLastPage() >= 9)
			{
				if($page < 4)		
				{
					...
					$pagination .= "...";
					$pagination .= "<a href=$this->website$lpm1".".html>".$lpm1."</a>";
					$pagination .= "<a href=$this->website".$this->getLastPage().".html>".$this->getLastPage()."</a>";		
				}
				elseif($this->getLastPage() - 3 > $page && $page > 1)
				{
					$pagination .= "<a href=$this->website"."1.html>1</a>";
					$pagination .= "<a href=$this->website"."2.html>2</a>";
					$pagination .= "...";
		...
		if ($page < $counter - 1) 
			$pagination .= "<a href=$this->website$next".".html>Next Page</a>";
		else
