                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>{{ __('Edit Advertisement') }}: {{ $advertisement->name }}</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('advertisements.update', $advertisement->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('ad_code') is-invalid @enderror" 
                                            ...
                                            placeholder="{{ __('Enter your advertisement HTML/JavaScript code here...') }}" required>{{ old('ad_code', $advertisement->ad_code) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('advertisements.show', $advertisement->id) }}" class="btn btn-info">
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    imagePreview.innerHTML = `
                        ...
                        <p class="text-muted mt-1">{{ __('New image preview') }}</p>
                    `;
                };
