@php
    $page_title = 'Mortgage Calculator - Calculate Monthly Mortgage Payment';
    $meta_desc = 'Calculate your monthly mortgage payment with our free online mortgage calculator';
    $heading = 'Mortgage Calculator';
    $body = 'Calculate your monthly mortgage payment based on loan amount, interest rate, and loan term.';
@endphp
...
@section('calculator-content')
    ...
    <form method="post" action="{{ route('calculator.mortgage') }}">
        @csrf
            ...
            <ul>
                <li style="display: block;">
                    ...
                    <div class="ginput_container">
                        <input type="number" name="loan_amount" value="{{ old('loan_amount', 200000) }}" required class="medium" step="0.01">
                    </div>
                </li>
                ...
                <li style="display: block;">
                    ...
                    <div class="ginput_container">
                        <input type="number" name="interest_rate" value="{{ old('interest_rate', 5) }}" required class="medium" step="0.01">
                    </div>
                </li>
    ...
    @if($result)
        <table class="calculator_table">
            <tbody>
                <tr>
                    <td colspan="2"><strong>Mortgage Calculation Results</strong></td>
                </tr>
                <tr>
                    <th>Loan Amount</th>
