...
include("includes/front_common.php");
...
<script type="application/ld+json">
{
   ...
   "potentialAction": {
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $path; ?>css/pagination.css" />
    <div class="home">
                                    ...
                                    <div class="responsive_cell_home_center">
                                        <div class="featuredContent contentBlock">
                                            ...
                                            <script type="text/javascript">
                                                $().ready(function() {
                                                    $("#english_words_1").autocomplete("<?php echo $path; ?>includes/wordslist_ajax.php", {
                                                        width: 260,
                                                        matchContains: true,
                                                        //mustMatch: true,
                                                        //minChars: 0,
                                            ...
                                            <?php //include("includes/banners/468x60.php");
                                            ?>

                                            <hr style="margin-bottom:5px; border: 1px dashed #d3d3d3;">
                                            <div style="margin-bottom:20px;">
                                                <strong>English to Urdu Dictionary</strong> <img style=" float:right; height:30px;" src="<?php echo $path; ?>images/english_.png">
                                            </div>

                                            <div class="box">
                                                <form action="<?php echo $path; ?>includes/front_controller.php" method="post">
                                            ...
                                            <center>
                                                <a href="<?php echo $path; ?>"><img src="<?php echo $path; ?>images/english_btn.png" title="Click English to Urdu Dictionary" alt="Click English to Urdu Dictionary" style="height:35px;"></a>
                                                <a href="<?php echo $path ?>roman.html"><img src="<?php echo $path; ?>images/roman_btn.png" title="Click Roman Urdu to English Dictionary" alt="Click Roman Urdu to English Dictionary" style="height:35px;"></a>
                                                <a href="<?php echo $path ?>urdu.html"><img title="Click Urdu to English Dictionary" alt="Click Urdu to English Dictionary" src="<?php echo $path; ?>images/urdu_btn.png" style="height:35px;"></a>


                                                <hr style="margin-bottom:5px;">


                                                <a href="<?php echo $path; ?>english_words/A.html"><strong>A</strong></a> -

                                                <a href="<?php echo $path; ?>english_words/B.html"><strong>B</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/C.html"><strong>C</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/D.html"><strong>D</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/E.html"><strong>E</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/F.html"><strong>F</strong></a> -

                                                <a href="<?php echo $path; ?>english_words/G.html"><strong>G</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/H.html"><strong>H</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/I.html"><strong>I</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/J.html"><strong>J</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/K.html"><strong>K</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/L.html"><strong>L</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/M.html"><strong>M</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/N.html"><strong>N</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/O.html"><strong>O</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/P.html"><strong>P</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/Q.html"><strong>Q</strong></a> -

                                                <a href="<?php echo $path; ?>english_words/R.html"><strong>R</strong></a>
                                                <br>
                                                <a href="<?php echo $path; ?>english_words/S.html"><strong>S</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/T.html"><strong>T</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/U.html"><strong>U</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/V.html"><strong>V</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/W.html"><strong>W</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/X.html"><strong>X</strong></a> -


                                                <a href="<?php echo $path; ?>english_words/Y.html"><strong>Y</strong></a> -
                                                <a href="<?php echo $path; ?>english_words/Z.html"><strong>Z</strong></a>
                                                <hr style="margin-bottom:5px;">
                                            </center>
                                            ...
                                            <?php /* ?><div style="width:336px; height:280px">
...
<?php */ ?>
                                            <?php include('includes/banners/200x90.php'); ?>
                                ...
                                <div class="responsive_row">
                                        ...
                                        <div class="responsive_row rssPanel">
                                            <div class="responsive_cell_home_center_half">
                                                <div class="contentBlock halfBlock purpleBlock">
                                                    <div class="blockBody">
                                                        <h2><a href="<?php echo $path; ?>roman.html">Roman Urdu To English Dictionary</a></h2>
                                                    ...
                                                    <div class="readMore"><a href="<?php echo $path; ?>roman.html">Click Roman Dictionary
                                    ...
                                    <div class="responsive_cell_home_center_half responsive_no_margin_vertical">
                                        <div class="contentBlock halfBlock purpleBlock">
                                            <div class="blockBody">
                                                <h2><a href="<?php echo $path  ?>urdu.html">Urdu To English Dictionary</a></h2>
                                            ...
                                            <div class="readMore"><a href="<?php echo $path  ?>urdu.html">
                    ...
                    <div class="responsive_cell_home_left responsive_float_right responsive_no_margin ad_trick_left">
                        ...
                        <div class="responsive_row">
                            <div class="contentBlock responsive_cell">
                                <?php include("includes/banners/250x250.php"); ?>
                            </div>
                        </div>
    ...
    <div class="contentBlock trendingWordsPanel">
                <div class="blockBody">
                            ...
                            <div class="responsive_columns_2_on_smartphone ">
								...
								{ ?>
<li><a href="<?php echo $path . "learn-english/". $eng_row['sc_slug'];   ?>/" title="Click English Course in Urdu"><?php echo strtolower($eng_row['sc_slug']); ?></a> </li>

<li><a href="<?php echo $path . "learn-english/"  ?>" title="Meaning of <?php echo $eng_row['words']; ?>"><?php echo strtolower($eng_row['article_title']); ?></a> </li>
								<?php } ?>
                                    ...
                                    <div class="trendingWords" data-country="all" style="display:block;">
                                        ...
                                        <div class="responsive_columns_2_on_smartphone ">
                                            <ul>
                                                ...
                                                ?>
                                                    <li><a href="<?php echo $path . 'meaning/' . $popular_row['word_url'];   ?>" title="Meaning of <?php echo $popular_row['words']; ?>"><?php echo strtolower($popular_row['words']); ?></a> </li>
                                                <?php } ?>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <?php include("includes/follow_us.php"); ?>
                            ...
                            <table border="0" width="100%" cellspacing="0" cellpadding="6">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="14%" class="AlphabetButtons"> <a href="<?php echo $path; ?>urdu_words/wowhamza.html"></a></td>
