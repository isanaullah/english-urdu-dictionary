...
$().ready(function() {
	$("#urdu_lg").autocomplete("{{ $path }}includes/wordlist_urdu_ajax.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
		...
		$("#urdu_sms").autocomplete("{{ $path }}includes/wordlist_urdu_ajax.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
...
@include('frontend.includes.header_1')
    ...
    <div class="mobileSearch">
        <form action="{{ route('search.urdu') }}" method="post" class="quickLinks">
            @csrf
...
@include('frontend.includes.header_2')
            ...
            <div class="searchContain">
                   ...
                   {{-- <a id="keyboardsListBtn" class="icon-arrow-down responsive_hide_on_tablet"></a> --}}
